...
// 日本组合歌手列表
class RBBandArtistListPage extends StatefulWidget {
  @override
  _RBBandArtistListPageState createState() => _RBBandArtistListPageState();
}

class _RBBandArtistListPageState extends State<RBBandArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"6003&limit=100", (result){
      if(mounted){
        setState(() {

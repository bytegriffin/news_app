...
// 最新歌单列表页
class NewSongPlayListPage extends StatefulWidget {
  NewSongPlayListPage();
  @override
  _NewSongPlayListPageState createState() => _NewSongPlayListPageState();
}

class _NewSongPlayListPageState extends State<NewSongPlayListPage>{
  ...
  _getMusics(){
    HttpClient.get(NEW_PLAYLIST_URL, (result){
      if(mounted){
        setState(() {
          allTopList = NewPlayLists.fromJson(result).playlists;

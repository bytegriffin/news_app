...
// 日本男歌手列表
class RBNanArtistListPage extends StatefulWidget {
  @override
  _RBNanArtistListPageState createState() => _RBNanArtistListPageState();
}

class _RBNanArtistListPageState extends State<RBNanArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"6001&limit=100", (result){
      if(mounted){
        setState(() {

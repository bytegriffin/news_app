...
// 宠物视频
class ChongwuVideoListPage extends StatefulWidget {
  @override
  ChongwuVideoListPageState createState() => new ChongwuVideoListPageState();
}

class ChongwuVideoListPageState extends State<ChongwuVideoListPage> with AutomaticKeepAliveClientMixin {
...
//  int _beLoad = 0; // 0表示不显示, 1表示正在请求, 2表示没有更多数据
  ...
  void _getNewData(bool _ifAdd) async {
    HttpClient.getVideoApi(CHONGWU_VIDEO_URL, (result) {
      if(mounted){
        setState(() {

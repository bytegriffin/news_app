...
// 政治与法律列表页面
class ZFFreeBookListPage extends StatefulWidget {
  @override
  _ZFFreeBookListPageState createState() => _ZFFreeBookListPageState();
}

class _ZFFreeBookListPageState extends State<ZFFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, ZFBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

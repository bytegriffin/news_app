...
// 工业列表页面
class JTFreeBookListPage extends StatefulWidget {
  @override
  _JTFreeBookListPageState createState() => _JTFreeBookListPageState();
}

class _JTFreeBookListPageState extends State<JTFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, JTBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

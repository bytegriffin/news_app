...
// 自然列表页面
class ZRFreeBookListPage extends StatefulWidget {
  @override
  _ZRFreeBookListPageState createState() => _ZRFreeBookListPageState();
}

class _ZRFreeBookListPageState extends State<ZRFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, ZRBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

...
// 工业列表页面
class GYFreeBookListPage extends StatefulWidget {
  @override
  _GYFreeBookListPageState createState() => _GYFreeBookListPageState();
}

class _GYFreeBookListPageState extends State<GYFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, GYBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

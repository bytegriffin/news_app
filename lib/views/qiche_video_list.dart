...
// 汽车视频
class QicheVideoListPage extends StatefulWidget {
  @override
  QicheVideoListPageState createState() => new QicheVideoListPageState();
}

class QicheVideoListPageState extends State<QicheVideoListPage> with AutomaticKeepAliveClientMixin {
...
//  int _beLoad = 0; // 0表示不显示, 1表示正在请求, 2表示没有更多数据
  ...
  void _getNewData(bool _ifAdd) async {
    HttpClient.getVideoApi(QICHE_VIDEO_URL, (result) {
      if(mounted){
        setState(() {

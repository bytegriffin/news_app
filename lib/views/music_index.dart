...
class _MusicIndexPageState extends State<MusicIndexPage> with AutomaticKeepAliveClientMixin{
  ...
  _buildArtists(){
    ...
    artistList.add(Artist("4479","Hotdog","http://p2.music.126.net/EvwfM0Zj80LRLJo2VBeDTA==/109951164313587836.jpg?param=177y177"));
    artistList.add(Artist("4723","潘玮柏","http://p1.music.126.net/VbC0CDRFn-4fesL6eJFWjQ==/109951163766134127.jpg?param=177y177"));
    artistList.add(Artist("36490","巴赫","http://p1.music.126.net/dPp4HlN1c-HBXwc0nBwgaw==/109951163620844481.jpg?param=177y177"));

...
// 经济列表页面
class JJFreeBookListPage extends StatefulWidget {
  @override
  _JJFreeBookListPageState createState() => _JJFreeBookListPageState();
}

class _JJFreeBookListPageState extends State<JJFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, JJBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

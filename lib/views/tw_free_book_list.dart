...
// 天文列表页面
class TWFreeBookListPage extends StatefulWidget {
  @override
  _TWFreeBookListPageState createState() => _TWFreeBookListPageState();
}

class _TWFreeBookListPageState extends State<TWFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, TWBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

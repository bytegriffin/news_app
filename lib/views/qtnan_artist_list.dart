...
// 其他男歌手列表
class QTNanArtistListPage extends StatefulWidget {
  @override
  _QTNanArtistListPageState createState() => _QTNanArtistListPageState();
}

class _QTNanArtistListPageState extends State<QTNanArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"4001&limit=100", (result){
      if(mounted){
        setState(() {

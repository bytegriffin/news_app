...
// 生物科技列表页面
class SWFreeBookListPage extends StatefulWidget {
  @override
  _SWFreeBookListPageState createState() => _SWFreeBookListPageState();
}

class _SWFreeBookListPageState extends State<SWFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, SWBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

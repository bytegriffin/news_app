...
class SearchBookDetailPage extends StatefulWidget {
  final String searchId;
  SearchBookDetailPage(this.searchId);
  @override
  _SearchBookDetailPageState createState() => _SearchBookDetailPageState();
}

class _SearchBookDetailPageState extends State<SearchBookDetailPage> {
  SearchBook book;
  String summary = "";
  String authorIntro = "";
  String catalog = "";
  ...
  _getBooks(){
    HttpClient.get(getBookUrl+widget.searchId, (result){
      if(mounted){
        setState(() {

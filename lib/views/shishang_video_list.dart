...
// 时尚视频
class ShishangVideoListPage extends StatefulWidget {
  @override
  ShishangVideoListPageState createState() => new ShishangVideoListPageState();
}

class ShishangVideoListPageState extends State<ShishangVideoListPage> with AutomaticKeepAliveClientMixin {
...
//  int _beLoad = 0; // 0表示不显示, 1表示正在请求, 2表示没有更多数据
  ...
  void _getNewData(bool _ifAdd) async {
    HttpClient.getVideoApi(SHISHANG_VIDEO_URL, (result) {
      if(mounted){
        setState(() {

...
// 农业列表页面
class NYFreeBookListPage extends StatefulWidget {
  @override
  _NYFreeBookListPageState createState() => _NYFreeBookListPageState();
}

class _NYFreeBookListPageState extends State<NYFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, NYBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

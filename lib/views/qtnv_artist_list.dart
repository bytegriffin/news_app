...
// 其他女歌手列表
class QTNvArtistListPage extends StatefulWidget {
  @override
  _QTNvArtistListPageState createState() => _QTNvArtistListPageState();
}

class _QTNvArtistListPageState extends State<QTNvArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"4002&limit=100", (result){
      if(mounted){
        setState(() {

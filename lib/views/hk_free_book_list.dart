...
// 航空列表页面
class HKFreeBookListPage extends StatefulWidget {
  @override
  _HKFreeBookListPageState createState() => _HKFreeBookListPageState();
}

class _HKFreeBookListPageState extends State<HKFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, HKBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

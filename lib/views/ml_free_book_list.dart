...
// 马列主义列表页面
class MLFreeBookListPage extends StatefulWidget {
  @override
  _MLFreeBookListPageState createState() => _MLFreeBookListPageState();
}

class _MLFreeBookListPageState extends State<MLFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    Map<String,dynamic> map = MLBookPostData(this._pageNum).toJson();
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, map,(result){
      if (mounted) {

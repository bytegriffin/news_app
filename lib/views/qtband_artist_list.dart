...
// 其他组合歌手列表
class QTBandArtistListPage extends StatefulWidget {
  @override
  _QTBandArtistListPageState createState() => _QTBandArtistListPageState();
}

class _QTBandArtistListPageState extends State<QTBandArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"4003&limit=100", (result){
      if(mounted){
        setState(() {

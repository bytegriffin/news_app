...
// 日本女歌手列表
class RBNvArtistListPage extends StatefulWidget {
  @override
  _RBNvArtistListPageState createState() => _RBNvArtistListPageState();
}

class _RBNvArtistListPageState extends State<RBNvArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"6002&limit=100", (result){
      if(mounted){
        setState(() {

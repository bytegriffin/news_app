...
// 音乐视频
class YinyueVideoListPage extends StatefulWidget {
  @override
  YinyueVideoListPageState createState() => new YinyueVideoListPageState();
}

class YinyueVideoListPageState extends State<YinyueVideoListPage> with AutomaticKeepAliveClientMixin {
...
//  int _beLoad = 0; // 0表示不显示, 1表示正在请求, 2表示没有更多数据
  ...
  void _getNewData(bool _ifAdd) async {
    HttpClient.getVideoApi(YINYUE_VIDEO_URL, (result) {
      if(mounted){
        setState(() {

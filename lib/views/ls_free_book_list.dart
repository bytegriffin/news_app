...
// 历史列表页面
class LSFreeBookListPage extends StatefulWidget {
  @override
  _LSFreeBookListPageState createState() => _LSFreeBookListPageState();
}

class _LSFreeBookListPageState extends State<LSFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, LSBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

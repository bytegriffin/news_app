...
// 军事列表页面
class JSFreeBookListPage extends StatefulWidget {
  @override
  _JSFreeBookListPageState createState() => _JSFreeBookListPageState();
}

class _JSFreeBookListPageState extends State<JSFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, JSBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

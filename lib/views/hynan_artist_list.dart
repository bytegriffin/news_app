...
// 华语男歌手列表
class HYNanArtistListPage extends StatefulWidget {
  @override
  _HYNanArtistListPageState createState() => _HYNanArtistListPageState();
}

class _HYNanArtistListPageState extends State<HYNanArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"1001&limit=100", (result){
      if(mounted){
        setState(() {

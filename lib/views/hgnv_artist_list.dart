...
// 韩国女歌手列表
class HGNvArtistListPage extends StatefulWidget {
  @override
  _HGNvArtistListPageState createState() => _HGNvArtistListPageState();
}

class _HGNvArtistListPageState extends State<HGNvArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"7002&limit=100", (result){
      if(mounted){
        setState(() {

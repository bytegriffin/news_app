...
// 社会科学列表页面
class SKFreeBookListPage extends StatefulWidget {
  @override
  _SKFreeBookListPageState createState() => _SKFreeBookListPageState();
}

class _SKFreeBookListPageState extends State<SKFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, SKBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

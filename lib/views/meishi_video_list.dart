...
// 美食视频
class MeishiVideoListPage extends StatefulWidget {
  @override
  MeishiVideoListPageState createState() => new MeishiVideoListPageState();
}

class MeishiVideoListPageState extends State<MeishiVideoListPage> with AutomaticKeepAliveClientMixin {
...
//  int _beLoad = 0; // 0表示不显示, 1表示正在请求, 2表示没有更多数据
  ...
  void _getNewData(bool _ifAdd) async {
    HttpClient.getVideoApi(MEISHI_VIDEO_URL, (result) {
      if(mounted){
        setState(() {

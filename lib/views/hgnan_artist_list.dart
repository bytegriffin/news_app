...
// 韩国男歌手列表
class HGNanArtistListPage extends StatefulWidget {
  @override
  _HGNanArtistListPageState createState() => _HGNanArtistListPageState();
}

class _HGNanArtistListPageState extends State<HGNanArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"7001&limit=100", (result){
      if(mounted){
        setState(() {

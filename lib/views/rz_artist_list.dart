...
// 入驻歌手列表
class RZArtistListPage extends StatefulWidget {
  @override
  _RZArtistListPageState createState() => _RZArtistListPageState();
}

class _RZArtistListPageState extends State<RZArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"5001&limit=90", (result){
      if(mounted){
        setState(() {

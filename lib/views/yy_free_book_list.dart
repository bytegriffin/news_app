...
// 语言列表页面
class YYFreeBookListPage extends StatefulWidget {
  @override
  _YYFreeBookListPageState createState() => _YYFreeBookListPageState();
}

class _YYFreeBookListPageState extends State<YYFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, YYBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

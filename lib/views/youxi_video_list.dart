...
// 游戏视频
class YouxiVideoListPage extends StatefulWidget {
  @override
  YouxiVideoListPageState createState() => new YouxiVideoListPageState();
}

class YouxiVideoListPageState extends State<YouxiVideoListPage> with AutomaticKeepAliveClientMixin {
...
//  int _beLoad = 0; // 0表示不显示, 1表示正在请求, 2表示没有更多数据
  ...
  void _getNewData(bool _ifAdd) async {
    HttpClient.getVideoApi(YOUXI_VIDEO_URL, (result) {
      if(mounted){
        setState(() {

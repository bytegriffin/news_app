...
// 韩国组合歌手列表
class HGBandArtistListPage extends StatefulWidget {
  @override
  _HGBandArtistListPageState createState() => _HGBandArtistListPageState();
}

class _HGBandArtistListPageState extends State<HGBandArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"7003&limit=100", (result){
      if(mounted){
        setState(() {

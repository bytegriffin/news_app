...
// 欧美女歌手列表
class OMNvArtistListPage extends StatefulWidget {
  @override
  _OMNvArtistListPageState createState() => _OMNvArtistListPageState();
}

class _OMNvArtistListPageState extends State<OMNvArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"2002&limit=100", (result){
      if(mounted){
        setState(() {

...
// 华语女歌手列表
class HYNvArtistListPage extends StatefulWidget {
  @override
  _HYNvArtistListPageState createState() => _HYNvArtistListPageState();
}

class _HYNvArtistListPageState extends State<HYNvArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"1002&limit=100", (result){
      if(mounted){
        setState(() {

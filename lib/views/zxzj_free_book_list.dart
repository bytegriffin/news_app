...
// 哲学与宗教列表页面
class ZXZJFreeBookListPage extends StatefulWidget {
  @override
  _ZXZJFreeBookListPageState createState() => _ZXZJFreeBookListPageState();
}

class _ZXZJFreeBookListPageState extends State<ZXZJFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, ZXZJBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

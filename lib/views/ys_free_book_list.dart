...
// 艺术列表页面
class YSFreeBookListPage extends StatefulWidget {
  @override
  _YSFreeBookListPageState createState() => _YSFreeBookListPageState();
}

class _YSFreeBookListPageState extends State<YSFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, YSBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

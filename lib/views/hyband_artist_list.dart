...
// 华语组合歌手列表
class HYBandArtistListPage extends StatefulWidget {
  @override
  _HYBandArtistListPageState createState() => _HYBandArtistListPageState();
}

class _HYBandArtistListPageState extends State<HYBandArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"1003&limit=100", (result){
      if(mounted){
        setState(() {

...
// 环境列表页面
class HJFreeBookListPage extends StatefulWidget {
  @override
  _HJFreeBookListPageState createState() => _HJFreeBookListPageState();
}

class _HJFreeBookListPageState extends State<HJFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, HJBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

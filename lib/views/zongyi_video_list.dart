...
// 综艺视频
class ZongyiVideoListPage extends StatefulWidget {
  @override
  ZongyiVideoListPageState createState() => new ZongyiVideoListPageState();
}

class ZongyiVideoListPageState extends State<ZongyiVideoListPage> with AutomaticKeepAliveClientMixin {
...
//  int _beLoad = 0; // 0表示不显示, 1表示正在请求, 2表示没有更多数据
  ...
  void _getNewData(bool _ifAdd) async {
    HttpClient.getVideoApi(ZONGYI_VIDEO_URL, (result) {
      if(mounted){
        setState(() {

...
// 欧美男歌手列表
class OMNanArtistListPage extends StatefulWidget {
  @override
  _OMNanArtistListPageState createState() => _OMNanArtistListPageState();
}

class _OMNanArtistListPageState extends State<OMNanArtistListPage> with AutomaticKeepAliveClientMixin{
  int size = 0;
  ...
  _getMusics(){
    HttpClient.get(ARTIST_URL+"2001&limit=100", (result){
      if(mounted){
        setState(() {

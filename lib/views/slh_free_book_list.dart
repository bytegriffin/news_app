...
// 数理化列表页面
class SLHFreeBookListPage extends StatefulWidget {
  @override
  _SLHFreeBookListPageState createState() => _SLHFreeBookListPageState();
}

class _SLHFreeBookListPageState extends State<SLHFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, SLHBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

...
// 动漫视频
class DongmanVideoListPage extends StatefulWidget {
  @override
  DongmanVideoListPageState createState() => new DongmanVideoListPageState();
}

class DongmanVideoListPageState extends State<DongmanVideoListPage> with AutomaticKeepAliveClientMixin {
...
//  int _beLoad = 0; // 0表示不显示, 1表示正在请求, 2表示没有更多数据
  ...
  void _getNewData(bool _ifAdd) async {
    HttpClient.getVideoApi(DONGMAN_VIDEO_URL, (result) {
      if(mounted){
        setState(() {

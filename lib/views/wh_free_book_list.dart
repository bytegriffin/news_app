...
// 文化列表页面
class WHFreeBookListPage extends StatefulWidget {
  @override
  _WHFreeBookListPageState createState() => _WHFreeBookListPageState();
}

class _WHFreeBookListPageState extends State<WHFreeBookListPage> with AutomaticKeepAliveClientMixin{
  ...
  _getMoreData(bool _ifAdd){
    HttpClient.postFreeBook(FREE_BOOK_LIST_URL, WHBookPostData(this._pageNum).toJson(),(result){
      if (mounted) {

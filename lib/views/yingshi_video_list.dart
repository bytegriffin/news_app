...
// 影视视频
class YingshiVideoListPage extends StatefulWidget {
  @override
  YingshiVideoListPageState createState() => new YingshiVideoListPageState();
}

class YingshiVideoListPageState extends State<YingshiVideoListPage> with AutomaticKeepAliveClientMixin {
...
//  int _beLoad = 0; // 0表示不显示, 1表示正在请求, 2表示没有更多数据
  ...
  void _getNewData(bool _ifAdd) async {
    HttpClient.getVideoApi(YINGSHI_VIDEO_URL, (result) {
      if(mounted){
        setState(() {
